...
CONTAINER_PATH = "/gscratch/scrubbed/fanglab/xiaoqian/repo/hyak_narsad_remove_cs_minus_first_time_effect/narsad-fmri_1st_level_1.0.sif"
...
# Output directory
OUTPUT_DIR = os.path.join(DERIVATIVES_DIR, 'fMRI_analysis_remove_cs_minus_first')
...
#SBATCH --mem=40G
#SBATCH --time=2:00:00
#SBATCH --output=/gscratch/scrubbed/fanglab/xiaoqian/NARSAD/work_flows/remove_cs_minus_first_time_effect/firstLevel_timeEffect/{task}_sub_{sub}_%j.out
#SBATCH --error=/gscratch/scrubbed/fanglab/xiaoqian/NARSAD/work_flows/remove_cs_minus_first_time_effect/firstLevel_timeEffect/{task}_sub_{sub}_%j.err

module load apptainer
apptainer exec \\
    -B /gscratch/fang:/data \\
    -B /gscratch/scrubbed/fanglab/xiaoqian:/scrubbed_dir \\
    -B /gscratch/scrubbed/fanglab/xiaoqian/repo/hyak_narsad_remove_cs_minus_first_time_effect:/app \\
    {container_path} \\
...
def process_single_subject(args, layout, query):
    ...
    for part in layout.get(invalid_filters='allow', **query):
        if (part.entities['subject'] == args.subject and 
            ...
            work_dir = os.path.join(SCRUBBED_DIR, PROJECT_NAME, f'work_flows/remove_cs_minus_first_time_effect/firstLevel_timeEffect/{task}')
