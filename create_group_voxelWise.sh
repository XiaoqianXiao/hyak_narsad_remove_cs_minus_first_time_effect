...
if [[ -z "$SCRIPT_DIR" ]]; then
    SCRIPT_DIR="/gscratch/scrubbed/fanglab/xiaoqian/NARSAD/work_flows/remove_cs_minus_first_time_effect/groupLevel_timeEffect/${SCRIPT_SUBDIR}"
fi
...
apptainer exec -B /gscratch/fang:/data -B /gscratch/scrubbed/fanglab/xiaoqian:/scrubbed_dir -B /gscratch/scrubbed/fanglab/xiaoqian/repo/hyak_narsad_remove_cs_minus_first_time_effect:/app ${CONTAINER_PATH} \\
