...
def load_first_level_data():
    ...
    """
    try:
        firstlevel_dir = os.path.join(DERIVATIVES_DIR, 'fMRI_analysis_remove_cs_minus_first/firstLevel_timeEffect')
  ...
  python run_pre_group_voxelWise.py --subject N101 --phase phase2 --include-columns "subID,group_id,drug_id"
    ...
    try:
        ...
        if args.output_dir:
            ...
            base_results_dir = os.path.join(DERIVATIVES_DIR, 'fMRI_analysis_remove_cs_minus_first/groupLevel_timeEffect/whole_brain')
        ...
        if args.workflow_dir:
            ...
            # Standard base: groupLevel/whole_brain
            base_workflow_dir = os.path.join(SCRUBBED_DIR, PROJECT_NAME, 'work_flows/remove_cs_minus_first_time_effect/groupLevel_timeEffect/whole_brain')
